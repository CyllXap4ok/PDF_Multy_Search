...
class Ui_file_selection_screen(object):
    def setupUi(self, file_selection_screen):
        ...
        file_selection_screen.resize(727, 590)
        ...
        file_selection_screen.setMinimumSize(QSize(727, 590))
        file_selection_screen.setBaseSize(QSize(727, 590))
...
"}")
        ...
        self.files_grid.setGeometry(QRect(0, 0, 711, 494))
